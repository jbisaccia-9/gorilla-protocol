...
required=(
  ...
  "${HOSTING_DIR}/bin/idle_guard.sh"
  "${HOSTING_DIR}/bin/install_host_services.sh"
  "${HOSTING_DIR}/systemd/gorilla-streamer.service"
  "${HOSTING_DIR}/systemd/gorilla-idle-guard.service"
  "${HOSTING_DIR}/systemd/gorilla-idle-guard.timer"
  "${HOSTING_DIR}/gcp/gcp.env.example"
  "${HOSTING_DIR}/gcp/startup.sh"
  "${HOSTING_DIR}/gcp/lib/common.sh"
  "${HOSTING_DIR}/gcp/bin/preflight.sh"
  "${HOSTING_DIR}/gcp/bin/request_gpu_quota.sh"
  "${HOSTING_DIR}/gcp/bin/quota_status.sh"
  "${HOSTING_DIR}/gcp/bin/setup_budget.sh"
